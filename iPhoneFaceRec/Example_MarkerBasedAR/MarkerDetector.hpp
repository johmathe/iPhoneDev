...
class MarkerDetector {
 public:
   ...
   * @calibration[in] - Camera calibration (intrinsic and distortion components)
   * necessary for pose estimation.
   */
 ...
 protected:
  ...
  bool findMarkers(const BGRAVideoFrame& frame,
  ...
  void findContours(cv::Mat& thresholdImg, ContoursVector& contours,
  ...
  void recognizeMarkers(const cv::Mat& grayscale,
                        std::vector<Marker>& detectedMarkers);
